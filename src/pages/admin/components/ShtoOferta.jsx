...
export default function ShtoOferta({ klientId, closePop }) {
    ...
    const renderFileType = (type) => {
        if (type === 'xlsx' || type === 'xlsm' || type === 'xlsb' || type === 'xltx' || type === 'xls') {
            return Excel;
        } else if (type === 'pdf') {
            return Pdf;
        } else {
        ...
        <div className="shto-oferta-pop flex ai-center jc-center" >
            ...
            <div className="shto-oferta-pop-content container flex">
                        ...
                        {file ?
                            ...
                            <div className="flex ai-end" style={{ width: '100%' }} >
                                <div className="flex fd-column ai-start"  >
                                    <label className="label-file fs-14 fw-regular" htmlFor="#">Emri Doc</label>
                                    <input className="emri-doc" style={{ width: fileName.length + 'ch', }} type="text" value={fileName} onChange={e => setFilename(e.target.value)} />
                                </div>
                                <button className="ruaj-file-btn" onClick={() => dergoDoc()} >Ruaj</button>
                                <button className="ruaj-file-btn anullo-file-btn" onClick={() => setFile('')} >Anullo</button>
                            </div>

                            :
                            <>
                                <label className="ngarko-doc-btn fs-18 fw-regular" htmlFor="file" > Ngarko Doc</label>
                                <input type="file" id="file" accept=".pdf,image/*,.csv,.doc, .docx, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel,.xls,.xlsx" hidden onChange={(e) => {
                    ...
                    <div className="klient-ofertat flex ai-end">
                        {ofertat.map((oferta, index) => (
                            <div className="klient-ofertat-item flex fd-column ai-center">
                                ...
                                <div className="delete-oferta" onClick={() => setActiveIndex(index)}>
                ...
                <div className="shto-oferta-pop-content-right flex fd-column ai-center">
                    ...
                    <div className="shto-oferta-pop-content-right-items flex ai-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14.915" height="19.204" viewBox="0 0 14.915 19.204">
