                        ...
                        <div className="dokumente flex ai-center fd-column jc-end">
                            {index === activeIndex &&
                                <div className="dokumente-delete flex fd-column ai-center">
                                    <p className="fs-16 fw-regular">Jeni te sigurt qe doni ta fshini?</p>
                                    <div className="dokumente-delete-buttons">
                                        ...
                                        <button className="fs-16 fw-regular" onClick={() => setActiveIndex(-1)} >Jo</button>
                                    </div>
                                </div>
                            }
                            <div className="dokumente-close" style={{ display: activeIndex === index ? 'none' : '' }} onClick={() => setActiveIndex(index)} >
