...
export default function Porosite() {
    ...
    return (
        <>
            {klientDokumente && <KlientDokumente refreshData={() => refreshData()} closePop={() => openKlientDokumente(false)} klientId={klientId} />}
            {shtoPorosi && <ShtoPorosi refreshData={() => refreshData()} closePop={() => openShtoPorosi(false)} />}
            <div className="porosite-header flex ai-center jc-spaceb">
                ...
                <div className="flex ai-center" >
                    ...
                    <button className="porosite-header-btn-shto fs-18 fw-regular" onClick={() => openShtoPorosi(true)} > + Shto Porosi</button>
                </div>
            </div>
